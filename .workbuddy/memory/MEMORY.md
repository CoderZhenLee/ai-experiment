...
- ⚠️ 词汇循环(2026-08-19 起):GLOSSARY 共 36 词,12 课(8/18)已全部学完;第 13 课起取模循环复习,索引 = ((N-1)*3 + i) % 36(第 13 课=PE/PB/估值,与第 1 课相同);09:30 学堂与 15:35 日报的取词逻辑均已按此处理
...
- 推送节奏(4 个自动化,prompt 内置 PushPlus 推送,均指向 /Users/lizhen/ai-experiment):
  ...
  - ⚠️ 关键坑(2026-09-14 发现):调度器**不认 rrule 里的 BYDAY**——写成 `FREQ=DAILY;BYDAY=MO,TU,WE,TH,FR` 仍每天触发,周六周日也推送(用户投诉)。rrule 保持 DAILY 不动(改成 WEEKLY 有丢工作日的风险),兜底方案 = 4 个自动化 prompt 开头统一加「第 0 步 · 触发日自检」:先 date 确认星期几,周末(周总结则是非周五)立即停止、不推送不写文件。学堂 1786416869287 / 快报 1786416869322 / 日报 1785918218488 三个均已加(周总结 1786429518927 之前已有)
